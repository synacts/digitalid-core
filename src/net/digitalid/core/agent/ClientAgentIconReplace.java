...
final class ClientAgentIconReplace extends CoreServiceInternalAction {
    ...
    /**
     * Stores the semantic type {@code old.icon.client.agent@core.digitalid.net}.
     */
    private static final @Nonnull SemanticType OLD_ICON = SemanticType.create("old.icon.client.agent@core.digitalid.net").load(Image.TYPE);
    
    /**
     * Stores the semantic type {@code new.icon.client.agent@core.digitalid.net}.
     */
    private static final @Nonnull SemanticType NEW_ICON = SemanticType.create("new.icon.client.agent@core.digitalid.net").load(Image.TYPE);
    
    /**
     * Stores the semantic type {@code replace.icon.client.agent@core.digitalid.net}.
     */
    private static final @Nonnull SemanticType TYPE = SemanticType.create("replace.icon.client.agent@core.digitalid.net").load(TupleWrapper.TYPE, Agent.TYPE, OLD_ICON, NEW_ICON);
