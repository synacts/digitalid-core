...
final class AgentPermissionsRemove extends CoreServiceInternalAction {
     ...
     */
    private static final @Nonnull SemanticType TYPE = SemanticType.create("remove.permissions.agent@core.digitalid.net").load(TupleWrapper.TYPE, Agent.TYPE, FreezableAgentPermissions.TYPE);
