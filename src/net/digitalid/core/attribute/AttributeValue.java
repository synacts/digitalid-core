...
public abstract class AttributeValue implements Blockable, SQLizable {
     ...
     */
    public static final @Nonnull SemanticType CONTENT = SemanticType.create("content.attribute@core.digitalid.net").load(SelfcontainedWrapper.TYPE);
    
    /**
     * Stores the semantic type {@code value.attribute@core.digitalid.net}.
     */
    public static final @Nonnull SemanticType TYPE = SemanticType.create("value.attribute@core.digitalid.net").load(SignatureWrapper.TYPE, CONTENT);
    
    /**
     * Stores the semantic type {@code list.attribute@core.digitalid.net}.
     */
    public static final @Nonnull SemanticType LIST = SemanticType.create("list.attribute@core.digitalid.net").load(ListWrapper.TYPE, TYPE);
