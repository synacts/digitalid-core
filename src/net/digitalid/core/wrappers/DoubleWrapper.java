...
/**
 * Wraps values of the syntactic type {@code double@core.digitalid.net} for encoding and decoding.
 * 
...
public final class DoubleWrapper extends Wrapper<DoubleWrapper> {
     ...
     */
    private static final Wrapper.Factory<DoubleWrapper> FACTORY = new Factory(SEMANTIC);
    ...
    private static class Factory extends Wrapper.Factory<DoubleWrapper> {
         ...
         */
        protected Factory(@Nonnull @Loaded @BasedOn("double@core.digitalid.net") SemanticType type) {
            super(type, COLUMN);
    ...
    public static class ValueFactory extends Wrapper.ValueFactory<Double, DoubleWrapper> {
         ...
         * @param type the semantic type that corresponds to the wrapper.
         */
        protected ValueFactory(@Nonnull @Loaded @BasedOn("double@core.digitalid.net") SemanticType type) {
            super(type, FACTORY);
