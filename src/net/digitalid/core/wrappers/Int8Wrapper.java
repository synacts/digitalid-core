...
/**
 * Wraps values of the syntactic type {@code int8@core.digitalid.net} for encoding and decoding.
 * 
...
public final class Int8Wrapper extends Wrapper<Int8Wrapper> {
     ...
     */
    private static final Wrapper.Factory<Int8Wrapper> FACTORY = new Factory(SEMANTIC);
     ...
     */
    private static class Factory extends Wrapper.Factory<Int8Wrapper> {
         ...
         */
        protected Factory(@Nonnull @Loaded @BasedOn("int8@core.digitalid.net") SemanticType type) {
            super(type, COLUMN);
        ...
        @Pure
        @Override
        public @Nonnull Int8Wrapper decodeNonNullable(@Nonnull @NonEncoding Block block) throws InvalidEncodingException {
    ...
    @Pure
    @Override
    public @Nonnull Wrapper.Factory<Int8Wrapper> getFactory() {
    ...
    public static class ValueFactory extends Wrapper.ValueFactory<Byte, Int8Wrapper> {
         ...
         * @param type the semantic type that corresponds to the wrapper.
         */
        protected ValueFactory(@Nonnull @Loaded @BasedOn("int8@core.digitalid.net") SemanticType type) {
            super(type, FACTORY);
