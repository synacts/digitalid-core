...
public final class Int16Wrapper extends Wrapper<Int16Wrapper> {
     ...
     */
    private static final Wrapper.Factory<Int16Wrapper> FACTORY = new Factory(SEMANTIC);
    ...
    private static class Factory extends Wrapper.Factory<Int16Wrapper> {
         ...
         */
        protected Factory(@Nonnull @Loaded @BasedOn("int16@core.digitalid.net") SemanticType type) {
            super(type, COLUMN);
        ...
        @Pure
        @Override
        public @Nonnull Int16Wrapper decodeNonNullable(@Nonnull @NonEncoding Block block) throws InvalidEncodingException {
    ...
    public static class ValueFactory extends Wrapper.ValueFactory<Short, Int16Wrapper> {
         ...
         * @param type the semantic type that corresponds to the wrapper.
         */
        protected ValueFactory(@Nonnull @Loaded @BasedOn("int16@core.digitalid.net") SemanticType type) {
            super(type, FACTORY);
