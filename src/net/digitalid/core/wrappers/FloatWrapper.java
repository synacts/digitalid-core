...
/**
 * Wraps values of the syntactic type {@code float@core.digitalid.net} for encoding and decoding.
 * 
...
public final class FloatWrapper extends Wrapper<FloatWrapper> {
     ...
     */
    private static final Wrapper.Factory<FloatWrapper> FACTORY = new Factory(SEMANTIC);
     ...
     */
    private static class Factory extends Wrapper.Factory<FloatWrapper> {
         ...
         */
        protected Factory(@Nonnull @Loaded @BasedOn("float@core.digitalid.net") SemanticType type) {
            super(type, COLUMN);
    ...
    @Pure
    @Override
    public @Nonnull Wrapper.Factory<FloatWrapper> getFactory() {
    ...
    public static class ValueFactory extends Wrapper.ValueFactory<Float, FloatWrapper> {
         ...
         * @param type the semantic type that corresponds to the wrapper.
         */
        protected ValueFactory(@Nonnull @Loaded @BasedOn("float@core.digitalid.net") SemanticType type) {
            super(type, FACTORY);
