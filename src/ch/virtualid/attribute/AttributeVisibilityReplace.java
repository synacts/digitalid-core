...
final class AttributeVisibilityReplace extends CoreServiceInternalAction {
     ...
     */
    private static final @Nonnull SemanticType OLD_VISIBILITY = SemanticType.create("old.visibility.attribute@virtualid.ch").load(PassiveExpression.TYPE);
    
    /**
     * Stores the semantic type {@code new.visibility.attribute@virtualid.ch}.
     */
    private static final @Nonnull SemanticType NEW_VISIBILITY = SemanticType.create("new.visibility.attribute@virtualid.ch").load(PassiveExpression.TYPE);
