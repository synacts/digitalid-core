...
public final class PersonalExpression extends AbstractExpression implements Immutable, Blockable, SQLizable {
     ...
     */
    public PersonalExpression(@Nonnull NonHostEntity entity, @Nonnull String string) throws InvalidEncodingException {
        super(entity, string);
    }
     ...
     */
    public PersonalExpression(@Nonnull NonHostEntity entity, @Nonnull Block block) throws InvalidEncodingException {
        super(entity, block);
    }
