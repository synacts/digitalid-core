...
public final class AttributeValueReplace extends CoreServiceInternalAction {
    ...
    public AttributeValueReplace(Attribute aThis, boolean b, AttributeValue oldValue, AttributeValue newValue) {
        throw new UnsupportedOperationException("AttributeValueReplace in AttributeValueReplace is not supported yet.");
    }
