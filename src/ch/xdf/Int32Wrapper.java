...
/**
 * Wraps a block with the syntactic type {@code int32@xdf.ch} for encoding and decoding.
 * 
 * @author Kaspar Etter (kaspar.etter@virtualid.ch)
 * @version 2.0
 */
public final class Int32Wrapper extends BlockWrapper implements Immutable {
    
    /**
     * Stores the syntactic type {@code int32@xdf.ch}.
     */
    public static final @Nonnull SyntacticType TYPE = SyntacticType.create("int32@xdf.ch").load(0);
