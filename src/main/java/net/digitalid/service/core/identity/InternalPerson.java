...
public abstract class InternalPerson extends Person implements InternalNonHostIdentity {
     ...
     */
    public static final @Nonnull AbstractXDFConverter<InternalPerson, Object> XDF_CONVERTER = ChainingXDFConverter.get(new Identity.IdentifierConverter<>(InternalPerson.class), Identifier.XDF_CONVERTER.setType(IDENTIFIER));
     ...
     */
    public static final @Nonnull AbstractSQLConverter<InternalPerson, Object> SQL_CONVERTER = ChainingSQLConverter.get(new Identity.LongConverter<>(InternalPerson.class), Integer64Wrapper.getValueSQLConverter(DECLARATION));
