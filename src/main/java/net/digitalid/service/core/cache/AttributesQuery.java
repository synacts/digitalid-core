...
import net.digitalid.service.core.contact.ReadOnlyAttributeTypeSet;
import net.digitalid.service.core.contact.ReadOnlyContactPermissions;
...
public final class AttributesQuery extends CoreServiceExternalQuery {
     ...
     */
    @NonCommitting
    private AttributesQuery(@Nonnull Entity entity, @Nonnull SignatureWrapper signature, @Nonnull HostIdentifier recipient, @Nonnull Block block) throws AbortException, PacketException, ExternalException, NetworkException  {
