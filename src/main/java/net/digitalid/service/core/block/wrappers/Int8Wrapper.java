...
public final class Int8Wrapper extends ValueWrapper<Int8Wrapper> {
    ...
    /**
     * Stores the syntactic type {@code semantic.int8@core.digitalid.net}.
     */
    ...
    public static final class SQLConverter extends Wrapper.SQLConverter<Int8Wrapper> {
        ...
        private SQLConverter(@Nonnull @Validated String columnName) {
            super(Column.get(columnName, SQLType.TINYINT), SEMANTIC);
        }
     ...
     */
    @Pure
    public static @Nonnull ValueSQLConverter<Byte, Int8Wrapper> getValueSQLConverter(@Nonnull @Validated String columnName) {
     ...
     */
    @Pure
    public static @Nonnull Converters<Byte, Object> getValueConverters(@Nonnull @BasedOn("int8@core.digitalid.net") SemanticType type, @Nonnull @Validated String columnName) {
