...
public final class DoubleWrapper extends ValueWrapper<DoubleWrapper> {
     ...
     */
    @NonCommitting
    public static void store(double value, @Nonnull PreparedStatement preparedStatement, @Nonnull MutableIndex parameterIndex) throws FailedStoringException {
        try {
    ...
    @Pure
    @NonCommitting
    public static double restore(@Nonnull ResultSet resultSet, @Nonnull MutableIndex columnIndex) throws FailedRestoringException {
        try {
    ...
    public static final class SQLConverter extends AbstractWrapper.SQLConverter<DoubleWrapper> {
        ...
        @Override
        @NonCommitting
        public void storeNonNullable(@Nonnull DoubleWrapper wrapper, @Nonnull PreparedStatement preparedStatement, @Nonnull MutableIndex parameterIndex) throws FailedStoringException {
        ...
        @Override
        @NonCommitting
        public @Nullable DoubleWrapper restoreNullable(@Nonnull Object none, @Nonnull ResultSet resultSet, @Nonnull MutableIndex columnIndex) throws FailedRestoringException, CorruptStateException, InternalException {
            try {
