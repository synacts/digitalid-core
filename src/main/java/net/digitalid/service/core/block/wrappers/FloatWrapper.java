...
public final class FloatWrapper extends ValueWrapper<FloatWrapper> {
    ...
    /**
     * Stores the syntactic type {@code semantic.float@core.digitalid.net}.
     */
     ...
     */
    @Pure
    public static @Nonnull ValueSQLConverter<Float, FloatWrapper> getValueSQLConverter(@Nonnull @Validated String columnName) {
     ...
     */
    @Pure
    public static @Nonnull Converters<Float, Object> getValueConverters(@Nonnull @BasedOn("float@core.digitalid.net") SemanticType type, @Nonnull @Validated String columnName) {
