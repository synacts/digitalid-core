...
public final class Int64Wrapper extends Wrapper<Int64Wrapper> {
    ...
    public static @Nonnull @NonEncoding Block encode(@Nonnull @Loaded @BasedOn("int64@core.digitalid.net") SemanticType type, long value) {
        return new XDFConverter(type).encodeNonNullable(new Int64Wrapper(type, value));
    }
     ...
     */
    @Immutable
    public static final class XDFConverter extends Wrapper.NonRequestingXDFConverter<Int64Wrapper> {
     ...
     */
    @Immutable
    public static final class SQLConverter extends Wrapper.SQLConverter<Int64Wrapper> {
         ...
         */
        private SQLConverter(@Nonnull @BasedOn("int64@core.digitalid.net") SemanticType type) {
            super(COLUMN, type);
        }
     ...
     */
    @Pure
    public static @Nonnull ValueSQLConverter<Long, Int64Wrapper> getValueSQLConverter(@Nonnull @BasedOn("int64@core.digitalid.net") SemanticType type) {
     ...
     */
    @Pure
    public static @Nonnull Converters<Long, Object> getValueConverters(@Nonnull @BasedOn("int64@core.digitalid.net") SemanticType type) {
