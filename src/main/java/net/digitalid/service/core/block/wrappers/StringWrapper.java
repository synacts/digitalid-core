...
public final class StringWrapper extends ValueWrapper<StringWrapper> {
    ...
    /**
     * Stores the syntactic type {@code semantic.string@core.digitalid.net}.
     */
    ...
    public static final class SQLConverter extends Wrapper.SQLConverter<StringWrapper> {
        ...
        private SQLConverter(@Nonnull @Validated String columnName) {
            super(Column.get(columnName, SQLType.STRING), SEMANTIC);
        }
     ...
     */
    @Pure
    public static @Nonnull ValueSQLConverter<String, StringWrapper> getValueSQLConverter(@Nonnull @Validated String columnName) {
     ...
     */
    @Pure
    public static @Nonnull Converters<String, Object> getValueConverters(@Nonnull @BasedOn("string@core.digitalid.net") SemanticType type, @Nonnull @Validated String columnName) {
