...
/**
 * This exception indicates that a packet could not be received.
 */
@Immutable
public class ReceivingException extends NetworkException {
     ...
     */
    protected ReceivingException(@Nonnull IOException exception, @Nullable HostIdentifier host) {
     ...
     */
    @Pure
    public static final @Nonnull ReceivingException get(@Nonnull IOException exception, @Nullable HostIdentifier host) {
