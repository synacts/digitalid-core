...
final class ContactsAdd extends CoreServiceInternalAction {
     ...
     */
    @NonCommitting
    private ContactsAdd(@Nonnull Entity entity, @Nonnull SignatureWrapper signature, @Nonnull HostIdentifier recipient, @Nonnull Block block) throws DatabaseException, RequestException, ExternalException, NetworkException {
