...
final class ClientAgentNameReplace extends CoreServiceInternalAction {
     ...
     */
    @NonCommitting
    private ClientAgentNameReplace(@Nonnull Entity entity, @Nonnull SignatureWrapper signature, @Nonnull HostIdentifier recipient, @Nonnull Block block) throws AbortException, PacketException, ExternalException, NetworkException {
