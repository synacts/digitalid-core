...
public class XDFBooleanConverter extends XDFConverter<Boolean> {
    ...
    @Override
    protected @Nonnull Boolean convertFromNonNullable(@Nonnull Block block, @Nonnull Class<?> type, @Nonnull Map<Class<? extends Annotation>, Object> metaData) throws RestoringException {
        try {
