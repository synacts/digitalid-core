...
public final class ClientCredential extends Credential {
     ...
     */
    @NonCommitting
    public static @Nonnull @Active ClientCredential getRoleBased(@Nonnull @OfInternalPerson NonNativeRole role, @Nonnull @Frozen @NonEmpty ReadOnlyAgentPermissions permissions) throws DatabaseException, RequestException, ExternalException, NetworkException {
     ...
     */
    @NonCommitting
    public static @Nonnull @Active ClientCredential getIdentityBased(@Nonnull @OfInternalPerson Role role, @Nonnull @Frozen @NonEmpty ReadOnlyAgentPermissions permissions) throws DatabaseException, RequestException, ExternalException, NetworkException {
     ...
     */
    @NonCommitting
    public static @Nonnull @Active ClientCredential getAttributeBased(@Nonnull @OfInternalPerson Role role, @Nonnull CertifiedAttributeValue value, @Nonnull @Frozen @NonEmpty ReadOnlyAgentPermissions permissions) throws DatabaseException, RequestException, ExternalException, NetworkException {
