...
public abstract class ValueWrapper<W extends ValueWrapper<W>> extends Wrapper<W> {
     ...
     */
    @Immutable
    public final static class ValueEncodingFactory<V, W extends Wrapper<W>> extends net.digitalid.service.core.encoding.NonRequestingEncodingFactory<V, Object> {
