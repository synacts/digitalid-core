...
public final class Decimal64Wrapper extends ValueWrapper<Decimal64Wrapper> {
     ...
     */
    public static void store(double value, @NonCaptured @Nonnull @NonFrozen FreezableArray<String> values, @Nonnull MutableIndex index) {
     ...
     */
    @NonCommitting
    public static void store(double value, @NonCaptured @Nonnull ValueCollector collector) throws FailedValueStoringException {
        try {
    ...
    @Pure
    @NonCommitting
    public static double restore(@NonCaptured @Nonnull SelectionResult result) throws FailedValueRestoringException {
        try {
    ...
    public static final class SQLConverter extends AbstractWrapper.SQLConverter<Decimal64Wrapper> {
        ...
        @Override
        @NonCommitting
        public void storeNonNullable(@Nonnull Decimal64Wrapper wrapper, @NonCaptured @Nonnull ValueCollector collector) throws FailedValueStoringException {
        ...
        @Override
        @NonCommitting
        public @Nullable Decimal64Wrapper restoreNullable(@Nonnull Object none, @NonCaptured @Nonnull SelectionResult result) throws FailedValueRestoringException, CorruptValueException, InternalException {
            try {
