...
public class XDF {
    ...
    @Pure
    public static <T> void convert(@Nonnull T object, @Nonnull Converter<T, ?> converter, @Nonnull @Modified OutputStream outputStream) throws StreamException {
    ...
    @Pure
    public static <T> T recover(@Nonnull Converter<T, ?> converter, @Nonnull InputStream inputStream) throws StreamException {
