...
final class AgentRemove extends CoreServiceInternalAction {
     ...
     */
    @NonCommitting
    private AgentRemove(@Nonnull Entity entity, @Nonnull SignatureWrapper signature, @Nonnull HostIdentifier recipient, @Nonnull Block block) throws ExternalException {
