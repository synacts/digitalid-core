...
final class AgentRestrictionsReplace extends CoreServiceInternalAction {
     ...
     */
    @NonCommitting
    private AgentRestrictionsReplace(@Nonnull Entity entity, @Nonnull SignatureWrapper signature, @Nonnull HostIdentifier recipient, @Nonnull Block block) throws ExternalException {
