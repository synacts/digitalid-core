...
final class AuditQuery extends InternalQuery {
    ...
    @Hosts
    @NonCommitting
    private AuditQuery(@Nonnull Entity entity, @Nonnull @HasSubject SignatureWrapper signature, @Nonnull HostIdentifier recipient, @Nonnull @BasedOn("query.audit@core.digitalid.net") Block block) throws ExternalException {
