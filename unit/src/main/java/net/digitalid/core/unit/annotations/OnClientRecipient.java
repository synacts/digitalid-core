...
/**
 * This annotation indicates that a method may only be called {@link CoreUnitBased#isOnClient() on a client}.
 * 
 * @see OnHost
 * @see OnClient
 * @see OnHostRecipient
...
@MethodValidator(OnClientRecipient.Validator.class)
public @interface OnClientRecipient {
