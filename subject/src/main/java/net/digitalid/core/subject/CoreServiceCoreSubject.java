 ...
 */
@Immutable
public abstract class CoreServiceCoreSubject<@Unspecifiable ENTITY extends Entity, @Unspecifiable KEY> extends RootClass implements CoreSubject<ENTITY, KEY> {
