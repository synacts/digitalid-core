...
public abstract class Settings extends CoreConcept<NonHostEntity, None> {
    ...
    static final @Nonnull ConceptModule<NonHostEntity, None, Settings> MODULE = ConceptModuleBuilder.<NonHostEntity, None, Settings>withService(SERVICE).withConceptFactory(SettingsSubclass::new).withEntityConverter(NonHostEntityConverter.INSTANCE).withConceptConverter(SettingsConverter.INSTANCE).build();
    
    @Pure
    @Override
    @Generated("TODO in Subclass") // TODO: This should be generated by the '@GenerateConceptModule' annotation in the subclass.
    public @Nonnull ConceptModule<NonHostEntity, None, Settings> module() {
        return MODULE;
    }
    ...
    public static @Nonnull Settings of(@Nonnull NonHostEntity entity) {
        return Settings/* TODO: Subclass */.MODULE.getConceptIndex().get(entity, None.INSTANCE);
    }
