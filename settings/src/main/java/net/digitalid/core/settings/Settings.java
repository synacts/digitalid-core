...
public abstract class Settings extends CoreConcept<NonHostEntity, Object> {
    ...
    static final @Nonnull ConceptModule<NonHostEntity, Object, Settings> INFO = ConceptInfoBuilder.<NonHostEntity, Object, Settings>withService(SERVICE).withName("Settings").withIndex(ConceptIndexBuilder.buildWithFactory(SettingsSubclass::new)).withConverter(SettingsConverter.INSTANCE).build();
...
//    };
    ...
    static final @Nonnull PropertyRequiredAuthorization<Settings, String> PASSWORD_AUTHORIZATION = NonNullableRequiredAuthorizationBuilder.withRequiredRestrictionsToExecuteMethod((concept, value) -> Restrictions.ONLY_FOR_CLIENTS).withRequiredRestrictionsToSeeMethod((concept, value) -> Restrictions.ONLY_FOR_CLIENTS).build();
    ...
    @Generated("TODO in Subclass") // TODO: This should be generated by the '@GenerateProperty' annotation in the subclass.
    private static final @Nonnull NonNullableConceptPropertyInfo<@MaxSize(50) String, Settings, NonHostEntity> PASSWORD_INFO = NonNullableConceptPropertyInfoBuilder.withConceptInfo(INFO).withPropertyName("password").withValueConverter(StringConverter.INSTANCE).withRequiredAuthorization(PASSWORD_AUTHORIZATION).withValueValidator(PASSWORD_VALIDATOR).withDefaultValue("").build();
    ...
    */
    ...
    @Generated("TODO in Subclass") // TODO: This should be generated by the '@GenerateProperty' annotation in the subclass.
    private final @Nonnull NonNullableConceptProperty password = NonNullableConceptProperty.with(PASSWORD_INFO, this);
