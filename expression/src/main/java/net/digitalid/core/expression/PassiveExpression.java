...
public final class PassiveExpression extends AbstractExpression {
     ...
     */
    @NonCommitting
    public PassiveExpression(@Nonnull NonHostEntity entity, @Nonnull String string) throws ExternalException {
        super(entity, string);
    }
     ...
     */
    @NonCommitting
    public PassiveExpression(@Nonnull NonHostEntity entity, @Nonnull Block block) throws ExternalException {
        super(entity, block);
    }
