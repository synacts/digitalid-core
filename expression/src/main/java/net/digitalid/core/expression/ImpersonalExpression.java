...
public final class ImpersonalExpression extends AbstractExpression {
     ...
     */
    @NonCommitting
    public ImpersonalExpression(@Nonnull NonHostEntity entity, @Nonnull String string) throws ExternalException {
        super(entity, string);
    }
     ...
     */
    @NonCommitting
    public ImpersonalExpression(@Nonnull NonHostEntity entity, @Nonnull Block block) throws ExternalException {
        super(entity, block);
    }
