...
public final class Decimal32Wrapper extends ValueWrapper<Decimal32Wrapper> {
     ...
     */
    public static void store(float value, @NonCaptured @Nonnull @NonFrozen FreezableArray<String> values, @Nonnull MutableIndex index) {
     ...
     */
    @NonCommitting
    public static void store(float value, @NonCaptured @Nonnull ValueCollector collector) throws FailedValueStoringException {
        try {
    ...
    @Pure
    @NonCommitting
    public static float restore(@NonCaptured @Nonnull SelectionResult result) throws FailedValueRestoringException {
        try {
    ...
    public static final class SQLConverter extends AbstractWrapper.SQLConverter<Decimal32Wrapper> {
        ...
        @Override
        @NonCommitting
        public void storeNonNullable(@Nonnull Decimal32Wrapper wrapper, @NonCaptured @Nonnull ValueCollector collector) throws FailedValueStoringException {
        ...
        @Override
        @NonCommitting
        public @Nullable Decimal32Wrapper restoreNullable(@Nonnull Object none, @NonCaptured @Nonnull SelectionResult result) throws FailedValueRestoringException, CorruptValueException, InternalException {
            try {
