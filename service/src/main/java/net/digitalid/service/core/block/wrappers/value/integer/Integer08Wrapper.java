...
public final class Integer08Wrapper extends ValueWrapper<Integer08Wrapper> {
     ...
     */
    @NonCommitting
    public static void store(byte value, @NonCapturable @Nonnull ValueCollector collector) throws FailedValueStoringException {
        try {
    ...
    @Pure
    @NonCommitting
    public static byte restore(@NonCapturable @Nonnull SelectionResult result) throws FailedValueRestoringException {
        try {
    ...
    public static final class SQLConverter extends AbstractWrapper.SQLConverter<Integer08Wrapper> {
        ...
        @Override
        @NonCommitting
        public void storeNonNullable(@Nonnull Integer08Wrapper wrapper, @NonCapturable @Nonnull ValueCollector collector) throws FailedValueStoringException {
        ...
        @Override
        @NonCommitting
        public @Nullable Integer08Wrapper restoreNullable(@Nonnull Object none, @NonCapturable @Nonnull SelectionResult result) throws FailedValueRestoringException, CorruptValueException, InternalException {
            try {
