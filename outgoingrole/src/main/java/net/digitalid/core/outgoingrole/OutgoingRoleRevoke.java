...
final class OutgoingRoleRevoke extends CoreServiceExternalAction {
     ...
     */
    @NonCommitting
    private OutgoingRoleRevoke(@Nonnull Entity entity, @Nonnull SignatureWrapper signature, @Nonnull HostIdentifier recipient, @Nonnull Block block) throws ExternalException {
