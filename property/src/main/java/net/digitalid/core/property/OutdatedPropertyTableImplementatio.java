// TODO: Remove once this works with the new database abstraction.
...
// */
//@Immutable
//public abstract class OutdatedPropertyTableImplementatio<V, C extends Concept<C, E, ?>, E extends Entity> extends SiteTable {
//    
//    /* -------------------------------------------------- Type Mappings -------------------------------------------------- */
//    
//    /**
...
//     */
//    protected OutdatedPropertyTableImplementatio(@Nonnull ConceptPropertySetup<V, C, E> propertySetup) {
